...
export const Header = ({ izOffHrs }) => {
  ...
  return (
    <div className="header w-full mx-auto max-w-5xl mb-10 md:mb-20">
        <Link to="/" className="flex md:flex-start justify-center items-center pt-10">
          <div className="header__bio w-1/4 flex justify-center lg:w-1/12">
            <Img alt="headshot" image={image} className="w-full rounded-xl p-10" imgStyle={{ borderRadius: '50%' }} />
          </div>
      </Link>
      <Link to="/">
        <h1 className="text-3xl pl-2 text-center uppercase">Maxwell Kendall</h1>
      </Link>
